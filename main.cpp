...
int main()
{
	...
	do
	{
		cout << "[1] Добавление элемента очереди." << endl << "[2] Извлечение элемента очереди." << endl << "[3] Вывод очереди на экран."
			<< endl <<"[4] Меню элемента очереди."<< "[5] Запись всех элементов очереди в файл" << endl << "[6] Получить из файла элементы и запистаь в очередь" << endl <<"[0] Завершить работу." << endl;
		cin >> choice;
